...
describe('GET /api/v1/articles Tests a list of paginated articles', () => {
  it('should return 200 when the articles are paginated', (done) => {
    chai.request(app).get('/api/v1/articles?limit=2&offset=0')
      .end((req, res) => {
  ...
  it('should return 400 when the limit is not an integer', (done) => {
    chai.request(app).get('/api/v1/articles?limit=uj')
      .end((req, res) => {
  ...
  it('should return 400 when the limit is a negative integer', (done) => {
    chai.request(app).get('/api/v1/articles?limit=-2')
      .end((req, res) => {
        res.status.should.eql(400);
        res.body.should.be.a('object');
        res.body.should.have.property('errors');
  ...
  it('should return 400 when the offset is not an integer', (done) => {
    chai.request(app).get('/api/v1/articles?limit=2&offset=er')
      .end((req, res) => {
        res.status.should.eql(400);
        res.body.should.be.a('object');
        res.body.should.have.property('errors');
  ...
  it('should return 400 when the offset is a negative integer', (done) => {
    chai.request(app).get('/api/v1/articles?limit=2&offset=-2')
      .end((req, res) => {
        res.status.should.eql(400);
        res.body.should.be.a('object');
        res.body.should.have.property('errors');
  ...
  it('should return 404 when the offset and limit finds no article', (done) => {
    chai.request(app).get('/api/v1/articles?limit=0&offset=0')
      .end((req, res) => {
...
describe('GET /api/v1/users/:username/articles Tests a list of paginated articles which belongs to a given', () => {
  it('should return 200 when there are articles that belongs to the author and the articles are paginated', (done) => {
    chai.request(app).get('/api/v1/users/1/articles?limit=2&offset=0')
      .end((req, res) => {
        res.status.should.eql(200);
        res.body.should.be.a('object');
        res.body.should.have.property('status').eql('success');
  ...
  it('should return 400 when the userId is not a number', (done) => {
    chai.request(app).get('/api/v1/users/ij/articles?limit=2')
      .end((req, res) => {
        res.status.should.eql(400);
        res.body.should.be.a('object');
        res.body.should.have.property('message');
  ...
  it('should return 400 when the limit is not an integer', (done) => {
    chai.request(app).get('/api/v1/users/1/articles?limit=uj')
      .end((req, res) => {
        res.status.should.eql(400);
        res.body.should.be.a('object');
        res.body.should.have.property('errors');
  ...
  it('should return 400 when the limit is a negative integer', (done) => {
    chai.request(app).get('/api/v1/users/1/articles?limit=-2')
      .end((req, res) => {
        res.status.should.eql(400);
        res.body.should.be.a('object');
        res.body.should.have.property('errors');
  ...
  it('should return 400 when the offset is not an integer', (done) => {
    chai.request(app).get('/api/v1/users/1/articles?limit=2&offset=er')
      .end((req, res) => {
        res.status.should.eql(400);
        res.body.should.be.a('object');
        res.body.should.have.property('errors');
  ...
  it('should return 400 when the offset is a negative integer', (done) => {
    chai.request(app).get('/api/v1/users/1/articles?limit=2&offset=-2')
      .end((req, res) => {
        res.status.should.eql(400);
        res.body.should.be.a('object');
        res.body.should.have.property('errors');
  ...
  it('should return 404 when no articles where found for the user', (done) => {
    chai.request(app).get('/api/v1/users/200/articles?limit=0&offset=0')
      .end((req, res) => {
        res.status.should.eql(404);
        res.body.should.be.a('object');
        res.body.should.have.property('status').eql('error');
